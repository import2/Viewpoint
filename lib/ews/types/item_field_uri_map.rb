  ...
  module EWS
    module ItemFieldUriMap
      ...
      FIELD_URIS= {
        ...
        # :parent_folder_id  => {:text => 'item:ParentFolderId', :writable => true}, duplicate key
        :display_name  => {:text => 'folder:DisplayName', :writable => true},
        # :display_name  => {:text => 'contacts:DisplayName', :writable => true}, duplicate key
        :unread_count  => {:text => 'folder:UnreadCount', :writable => true},
        # :unread_count  => {:text => 'conversation:UnreadCount', :writable => true}, duplicate key
        ...
        # :effective_rights  => {:text => 'item:EffectiveRights', :writable => true}, duplicate key
        ...
        # :size  => {:text => 'conversation:Size', :writable => true}, duplicate key
        :categories  => {:text => 'item:Categories', :writable => true},
        # :categories  => {:text => 'conversation:Categories', :writable => true}, duplicate key
        :has_attachments  => {:text => 'item:HasAttachments', :writable => true},
        # :has_attachments  => {:text => 'conversation:HasAttachments', :writable => true}, duplicate key
        :importance  => {:text => 'item:Importance', :writable => true},
        # :importance  => {:text => 'conversation:Importance', :writable => true}, duplicate key
        ...
        # :culture  => {:text => 'contacts:Culture', :writable => true}, duplicate key
        ...
        # :conversation_id  => {:text => 'conversation:ConversationId', :writable => true}, duplicate key
        ...
        # :conversation_topic  => {:text => 'conversation:ConversationTopic', :writable => true}, duplicate key
        ...
        # :is_response_requested  => {:text => 'calendar:IsResponseRequested', :writable => true}, duplicate key
        ...
        # :is_recurring  => {:text => 'task:IsRecurring', :writable => true}, duplicate key
        ...
        # :recurrence  => {:text => 'task:Recurrence', :writable => true}, duplicate key
        ...
        # :companies  => {:text => 'contacts:Companies', :writable => true}, duplicate key
        ...
        # :mileage  => {:text => 'contacts:Mileage', :writable => true}, duplicate key
